  ...
  return (
    <div className="container mx-auto p-6 bg-white shadow-lg rounded-lg">
      <div className="flex flex-col md:flex-row items-center mb-8">
        ...
        />
        <h1 className="text-3xl font-bold mb-6 text-center">{scholar.name}</h1>
        <div className="text-center md:text-left">
          <p className="text-lg mb-2">
            <strong>Affiliation:</strong> {scholar.affiliation}
          </p>
          <p className="text-lg mb-2">
            <strong>Title:</strong> {scholar.title}
          </p>
          <p className="text-lg mb-2">
            <strong>Email:</strong> {scholar.contact.email}
          </p>
          <p className="text-lg mb-2">
            <strong>Phone:</strong> {scholar.contact.phone}
          </p>
          <p className="text-lg mb-2">
      ...
      <div className="mb-8">
        ...
        <p className="text-lg">{scholar.researchInterests.join(", ")}</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        ...
        <div>
          ...
          {scholar.publications &&
            scholar.publications.map((pub, index) => (
              <div key={index} className="mb-4">
                <p className="text-lg">
      ...
      <div className="mb-8">
        ...
        {scholar.professionalExperience &&
          scholar.professionalExperience.map((exp, index) => (
            <div key={index} className="mb-4">
              <p className="text-lg">
      ...
      <div className="mb-8">
        ...
        {scholar.honorsAndAwards &&
          scholar.honorsAndAwards.map((honor, index) => (
            <div key={index} className="mb-4">
              <p className="text-lg">
      ...
      <div className="mb-8">
        <p className="text-lg">
          ...
          {scholar.professionalMemberships.join(", ")}
        </p>
        <p className="text-lg">
          <strong>Skills:</strong> {scholar.skills.join(", ")}
        </p>
      </div>
      ...
      <div className="space-y-2 mb-8">
        <p className="text-lg">
          ...
          <a
            href={scholar.socialMediaProfiles.linkedIn}
            className="text-blue-500 underline"
          >
            {scholar.socialMediaProfiles.linkedIn}
          </a>
        </p>
        <p className="text-lg">
          <strong>ResearchGate:</strong>{" "}
          <a
            href={scholar.socialMediaProfiles.researchGate}
            className="text-blue-500 underline"
          >
            {scholar.socialMediaProfiles.researchGate}
          </a>
        </p>
      </div>
      <Link
